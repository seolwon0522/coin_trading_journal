...
export function ProfessionalOrderBook({ symbol, limit = 20 }: ProfessionalOrderBookProps) {
  ...
  return (
    <Card className="h-full bg-transparent border-0 p-0 overflow-hidden flex flex-col">
      {/* 헤더 */}
      ...
      <div className="flex flex-col flex-1 relative">
        <div className="grid grid-cols-2 flex-1 min-h-0 relative">
          {/* 매수 호가 */}
          <div className="border-r border-[#2a2a2a] overflow-y-auto scrollbar-thin bg-[#161616] h-full">
          ...
          {/* 매도 호가 */}
          <div className="overflow-y-auto scrollbar-thin bg-[#161616] h-full">
        ...
        {/* 스프레드 정보 - 호가창 하단에 오버레이 */}
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#1a1a1a] to-transparent pt-4 pb-1">
          <div className="px-2 bg-[#1a1a1a]/95 backdrop-blur-sm">
            ...
            {midPrice > 0 && (
              <div className="flex items-center justify-between text-[8px] pb-0.5">
