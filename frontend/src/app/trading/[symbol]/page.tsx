    ...
    <div className="h-screen bg-[#0d0d0d] flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          {/* 트레이딩 레이아웃 */}
          <div className="flex-1 flex flex-col overflow-hidden">
            <div className="flex-1 flex gap-1 px-1 py-1">
              {/* 왼쪽: 호가창 */}
              {showOrderBook && (
                <div className={cn(
                  "flex-shrink-0 transition-all duration-300",
                  isCompactMode ? "w-[320px]" : "w-[380px] 2xl:w-[420px]",
            ...
            <div className="flex-shrink-0 border-t border-border/50">
              <Card className="bg-background/50 backdrop-blur border-0 rounded-none p-0">
                <Tabs defaultValue="orders" className="w-full">
                  <TabsList className="w-full justify-start rounded-none bg-transparent border-b border-border/50 h-9 p-0">
                    <TabsTrigger
                      value="orders"
                  ...
                  <TabsContent value="orders" className="mt-0 p-2">
                  ...
                  <TabsContent value="trades" className="mt-0 p-2">
                    <div className="h-20 overflow-auto">
                      <div className="text-center py-4 text-muted-foreground text-xs">
                        거래 내역이 없습니다
                      </div>
